    ...
    `}_IconConditionsEditor(t,e,i){const n=e&&he(e)?e:{conditions:[],else:""},s=(t,e)=>{const s={conditions:[...n.conditions],else:n.else??""};s.conditions[t]={...s.conditions[t],...e},i(s)};return F`
      <div class="cond-wrap">
        ...
        ${n.conditions.length?n.conditions.map((t,e)=>F`
                <div class="cond-row">
                  <div class="field">${this._EntityPicker("Entity",t.entity??"",t=>s(e,{entity:t}))}</div>
                  <div class="field">
                    <ha-select
                      naturalMenuWidth
                      label="Operator"
                  ...
                  <div class="actions">${this._Btn("Remove",()=>(t=>{const e={conditions:[...n.conditions],else:n.else??""};e.conditions.splice(t,1),i(e)})(e),"danger")}</div>
                </div>
